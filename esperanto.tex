...
According to Benczik (1979), Esperanto is regarded by most of its users as a language best suited for translation.
...
However, due to the fact that no country uses Esperanto as its official language, there is no need for such translations, and the vast majority of translations from ethnic languages or vice versa are intended for publishing in print.
Benczik's article (1979) predated the invention of the World Wide Web by more than a decade.
Nowadays, it is conceivable that most translations from or into Esperanto end up being published on websites or as e-books.